...
public class FileController {
    ...
    public FileUploadResult uploadFile(@Argument final MultipartFile file, @Argument final long owner, @Argument final List<FileAccessPolicy> policy) throws FileUploadException {
        ...
        try {
            final var fileObject = fileService.save(new ru.ntdv.proicis.crud.model.File(file.getOriginalFilename(), userService.getUserById(owner), new HashSet<>(policy)));
    ...
    public FileUploadResult uploadParticipants(@Argument final MultipartFile file) throws CsvValidationException {
        ...
        try {
            ...
            final var fileObject = fileService.save(new ru.ntdv.proicis.crud.model.File(name, owner, Set.of(FileAccessPolicy.Administrators, FileAccessPolicy.Moderators)));
