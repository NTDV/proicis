...
public class Validations {
    ...
    public static final String LOGIN_SIZE_MESSAGE = "Login must contain at least " + LOGIN_SIZE_MIN + " and no more than " + LOGIN_SIZE_MAX + " characters.";
    ...
    public static final String PASSWORD_SIZE_MESSAGE = "Password must contain at least " + PASSWORD_SIZE_MIN + " and no more than " + PASSWORD_SIZE_MAX + " characters.";
    ...
    public static final String FIRSTNAME_SIZE_MESSAGE = "First name must contain at least " + FIRSTNAME_SIZE_MIN + " and no more than " + FIRSTNAME_SIZE_MAX + " characters.";
    ...
    public static final String SECONDNAME_SIZE_MESSAGE = "Second name must contain at least " + SECONDNAME_SIZE_MIN + " and no more than " + SECONDNAME_SIZE_MAX + " characters.";
    ...
    public static final String THIRDNAME_SIZE_MESSAGE = "Third name must contain at least " + THIRDNAME_SIZE_MIN + " and no more than " + THIRDNAME_SIZE_MAX + " characters.";
    ...
    public static final String URLVKONTAKTE_SIZE_MESSAGE = "VKontakte url must contain at least " + URLVKONTAKTE_SIZE_MIN + " and no more than " + URLVKONTAKTE_SIZE_MAX + " characters.";
    public static final String URLVKONTAKTE_PATTERN_REGEXP = "((http://|https://)?vk\\.com/|@|(id)).+";
    public static final String URLVKONTAKTE_PATTERN_MESSAGE = "URL must be in the format: https://vk.com/username or https://vk.com/id123456789 or @username or id123456789";

    public static final int URLTELEGRAM_SIZE_MIN = 2;
    public static final int URLTELEGRAM_SIZE_MAX = 120;
    public static final String URLTELEGRAM_SIZE_MESSAGE = "Telegram url must contain at least " + URLVKONTAKTE_SIZE_MIN + " and no more than " + URLVKONTAKTE_SIZE_MAX + " characters.";
    public static final String URLTELEGRAM_PATTERN_REGEXP = "((?<id>.+)\\.t.me)|((http://|https://)?t\\.me/|@).+";
    public static final String URLTELEGRAM_PATTERN_MESSAGE = "URL must be in the format: https://t.me/username or https://t.me/id123456789 or @username or id123456789 or username.t.me.";
    ...
    public static final String GROUP_SIZE_MESSAGE = "Group must contain at least " + GROUP_SIZE_MIN + " and no more than " + GROUP_SIZE_MAX + " characters.";
    ...
    public static final String ORGANIZATION_SIZE_MESSAGE = "Organization must contain at least " + ORGANIZATION_SIZE_MIN + " and no more than " + ORGANIZATION_SIZE_MAX + " characters.";
